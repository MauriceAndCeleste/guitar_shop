...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2017 at 04:12 AM
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `shippingStatus` varchar(7) NOT NULL DEFAULT 'pending',
  PRIMARY KEY (`orderID`),
  KEY `customerID` (`customerID`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=4 ;
...
INSERT INTO `orders` (`orderID`, `customerID`, `orderDate`, `shipAmount`, `taxAmount`, `shipDate`, `shipAddressID`, `cardType`, `cardNumber`, `cardExpires`, `billingAddressID`, `shippingStatus`) VALUES
(1, 1, '2014-05-30 09:40:28', '5.00', '32.32', '2014-06-01 09:43:13', 1, 2, '4111111111111111', '04/2019', 2, 'pending'),
(2, 2, '2014-06-01 11:23:20', '5.00', '0.00', NULL, 3, 2, '4111111111111111', '08/2018', 4, 'pending'),
(3, 1, '2014-06-03 09:44:58', '10.00', '89.92', NULL, 1, 2, '4111111111111111', '04/2019', 2, 'pending');
